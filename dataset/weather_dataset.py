...
weather_dataset.py
-------------------
PyTorch Dataset class for the prepared Weather dataset (21 meteorological indicators).
...
class WeatherDataset(Dataset):
    ...
    def __init__(
        self,
        data_dir="/workspaces/KARMA-/data/generated/weather",
        split="train",
    ):
...
def get_dataloaders(
    ...
    train_dataset = WeatherDataset(data_dir, "train")
    val_dataset = WeatherDataset(data_dir, "val")
    test_dataset = WeatherDataset(data_dir, "test")
