...
etth2.py
--------
Data preparation script for the ETT-h2 (Electricity Transformer Temperature, hourly)
dataset for time series forecasting with deep learning.

Usage:
    python dataset/etth2.py
"""
...
OUTPUT_DIR = "/workspaces/KARMA-/data/generated/etth2"
CSV_PATH = "/workspaces/KARMA-/data/raw/ETTh2.csv"

DATASET_NAME = "etth2"
DISPLAY_NAME = "ETT-h2 (Electricity Transformer Temperature, hourly)"
